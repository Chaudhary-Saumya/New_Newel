// components/IndustriesBuildingMaterials.jsx
...
export default function IndustriesBuildingMaterials() {
  ...
  const challenges = [
    {
      title: "Skilled Labor & Workforce Scaling",
      desc: "Sourcing reliable masons, machine operators, and laborers to maintain high production volumes and meet tight deadlines.",
      icon: (
    ...
    {
      title: "Plant Supervision & Operational Efficiency",
      desc: "Placing experienced plant supervisors and process coordinators to optimize mixing, batching, and manufacturing workflows.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Sales & Distribution Network Strength",
      desc: "Recruiting dynamic sales professionals to expand market reach, manage dealer networks, and drive revenue growth.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Ensuring rigorous testing, ISO standards, and material certification through expert QA inspectors and lab technicians.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Sustainability & Raw Material Management",
      desc: "Building teams that support eco-friendly practices, recycled materials integration, and efficient resource utilization.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              We support building materials companies with skilled laborers, plant supervisors, sales professionals, and quality assurance experts.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              Meet production targets and distribution goals in a competitive marketplace with reliable, high-performing teams.
            </p>
          ...
          <div ref={heroImgRef} className="mb-24 lg:mb-40">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 text-center mb-8">
              Our Building Materials Solutions
            </h2>
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Building Materials Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Cement & Silo Operations" : index === 1 ? "Concrete Batching Plants" : "Aggregates & Materials Yard"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Advanced cement production facilities" : index === 1 ? "High-volume concrete mixing" : "Large-scale material storage & handling"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Building Materials Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Strengthen Your Building Materials Business?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Build efficient, reliable teams of skilled workers, supervisors, sales experts, and QA professionals with Newel.
            </p>
            <a
              href="#contact"
