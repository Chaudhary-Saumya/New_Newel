// components/IndustriesDefence.jsx
...
// Defence related images (AI in defense, cybersecurity, autonomous systems)
const heroImages = [
  ...
  const challenges = [
    {
      ...
      desc: "Building robust defenses against cyber threats with experts in encryption, intrusion detection, and secure architectures.",
      icon: (
    ...
    {
      title: "AI & Autonomous Systems Integration",
      desc: "Developing and deploying AI-driven drones, vehicles, and decision systems for enhanced operational efficiency.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Implementing systems for rapid data analysis, predictive modeling, and proactive threat response.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Creating encrypted, resilient networks for reliable command, control, and information sharing.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Ensuring secure, diversified supply chains for critical components and materials in defense manufacturing.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              Technological supremacy and cybersecurity are becoming as critical as physical defense.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              Modern defense strategies are driven by AI, autonomous systems, and real-time threat intelligence. The need for integrated digital ecosystems, secure communication networks, and resilient supply chains is reshaping how defense operations are planned and executed globally.
            </p>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "AI-Driven Intelligence" : index === 1 ? "Cyber Defense Systems" : "Autonomous Operations"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Advanced AI analytics platforms" : index === 1 ? "Secure cyber operations centers" : "Unmanned autonomous vehicles"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Defence Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Advance Your Defence Capabilities?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Build integrated, secure, and innovative defence ecosystems with Newel.
            </p>
            <a
              href="#contact"
