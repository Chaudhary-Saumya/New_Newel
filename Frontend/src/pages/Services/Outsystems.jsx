// src/pages/services/Outsystems.jsx
...
export default function Outsystems() {
  ...
  useEffect(() => {
    document.title = 'OutSystems | Newel';
  }, []);
  ...
  const offerItems = [
    {
      title: 'High-quality web/mobile apps development with the OutSystems Platform',
      icon: Smartphone,
      color: 'indigo',
    },
    {
      title: 'Outsystem consultant on demand',
      icon: Users,
      color: 'blue',
    },
  ];
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="hero-text space-y-6 text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl">
                <p>
                  OutSystems is a Powerful, feature-packed low-code development platform for large enterprises or developers looking to publish straight to consumer app stores.
                </p>
                <p>
                  Platform for the development of mobile and web enterprise applications, which run in the cloud, on-premises or in hybrid environments.
                </p>
                <p>
                  This is a mature, well-designed tool that builds good-looking apps and handles the entire software development lifecycle. It also saves organization employee quality time in critical work compare to hiring, compliance etc.
                </p>
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="illustration relative max-w-lg mx-auto">
                ...
                {/* Floating OutSystems-style icons */}
  ...
  <div className="max-w-3xl mx-auto px-6 text-center">
    ...
    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
      Ready to build fast with OutSystems?
    </h2>

    <p className="text-lg md:text-xl text-gray-700 mb-8">
      Accelerate enterprise app development with powerful low-code — let's start your project today.
    </p>
