// components/IndustriesFoodAndBeverage.jsx
...
export default function IndustriesFoodAndBeverage() {
  ...
  const challenges = [
    {
      ...
      desc: "Staffing QA experts to enforce HACCP, ISO 22000, and rigorous testing protocols for consistent product safety.",
      icon: (
    ...
    {
      title: "Production Management & Efficiency",
      desc: "Placing experienced production managers to optimize throughput, reduce waste, and maintain high-volume operations.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Recruiting skilled packaging staff to ensure accurate labeling, sustainable materials, and regulatory adherence.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "R&D & Product Innovation",
      desc: "Sourcing R&D specialists to develop new formulations, improve shelf life, and meet evolving consumer preferences.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Building resilient supply chain teams to manage raw material sourcing, logistics, and mitigate disruptions.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              We support food manufacturers and processors with quality assurance experts, production managers, packaging staff, and R&D specialists.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              We help ensure food safety, compliance, and supply chain continuity in this critical industry.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Food & Beverage Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Processing Lines" : index === 1 ? "Packaging Excellence" : "Quality Assurance"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "High-efficiency food production" : index === 1 ? "Automated packaging systems" : "Rigorous safety testing"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Food & Beverage Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Strengthen Your Food & Beverage Operations?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Build safe, compliant, and efficient teams with Newel to support quality, innovation, and supply chain reliability.
            </p>
            <a
              href="#contact"
