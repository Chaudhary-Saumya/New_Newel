// components/IndustriesFertilizer.jsx
...
export default function IndustriesFertilizer() {
  ...
  const challenges = [
    {
      title: "Agronomy & Crop Nutrition Expertise",
      desc: "Sourcing agronomists skilled in soil analysis, nutrient management, and sustainable farming practices.",
      icon: (
    ...
    {
      title: "Chemical Engineering & Formulation",
      desc: "Staffing chemical engineers to develop and optimize fertilizer blends for maximum efficacy and minimal environmental impact.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Plant Operations & Safety Management",
      desc: "Providing experienced plant operators to ensure efficient production, equipment maintenance, and adherence to safety protocols.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Recruiting specialists to manage raw material sourcing, distribution networks, and timely delivery to agricultural markets.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Building teams focused on eco-friendly production, waste reduction, and compliance with agricultural and environmental regulations.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              We staff agronomists, chemical engineers, plant operators, and supply chain specialists to keep fertilizer production efficient and safe.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              Supporting the backbone of agricultural productivity in this essential industry.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Fertilizer Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Production Facilities" : index === 1 ? "Chemical Formulation" : "Agricultural Application"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Modern fertilizer plants" : index === 1 ? "Advanced engineering labs" : "Field nutrient management"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Fertilizer Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Enhance Your Fertilizer Production?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Build efficient, safe teams of agronomists, engineers, operators, and specialists with Newel.
            </p>
            <a
              href="#contact"
