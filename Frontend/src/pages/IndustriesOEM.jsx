...
// OEM related images (precision manufacturing, assembly lines, robotic production)
const heroImages = [
  "https://www.agg-net.com/sites/default/files/styles/agg23_news_image_870x580/public/2025-08/komatsu_manufacturing_lines.jpg.webp?itok=X0NBALXE",  // Komatsu heavy equipment assembly
  "https://img.oemoffhighway.com/files/base/acbm/ooh/image/2012/08/sany-worldslargestexcavatorfac_10764626.png?auto=format%2Ccompress&fit=max&q=70&w=1200",  // SANY excavator production line
  "https://images.sw.cdn.siemens.com/siemens-disw-assets/public/36Bh23LztCPIyYaOJUfL27/en-US/Car-Factory-3D-Concept-Automated-Robot-Arm-Assembly-Line-Manufacturing_v2.jpg?auto=format,compress&fit=crop&crop=faces,edge&w=2560&h=1440&q=60",  // Advanced robotic automotive OEM assembly
];

export default function IndustriesOEM() {
  ...
  const challenges = [
    {
      ...
      desc: "Securing top-tier design engineers and CAD specialists to drive accurate, innovative product development.",
      icon: (
    ...
    {
      title: "R&D Innovation Acceleration",
      desc: "Building teams of R&D specialists to push boundaries in materials, efficiency, and next-gen technologies.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Production Planning & Scaling",
      desc: "Staffing expert production planners to optimize workflows, meet tight deadlines, and scale output reliably.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Ensuring rigorous standards and regulatory adherence through skilled quality engineers and inspectors.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Supply Chain & Reliability Management",
      desc: "Maintaining dependable component sourcing and resilient operations in dynamic global markets.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            <h1 className="text-5xl md:text-5xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-none">
              OEM <br /> (Original Equipment Manufacturer)
            </h1>
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              OEMs require a blend of precision, innovation, and reliability.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              We staff design engineers, CAD experts, R&D specialists, and production planners who help OEMs maintain excellence and meet demand across industries.
            </p>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Precision Assembly" : index === 1 ? "High-Volume Production" : "Robotic Automation"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Advanced manufacturing lines" : index === 1 ? "Scalable OEM workflows" : "Cutting-edge robotic integration"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for OEM Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Power Your OEM Excellence?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Build precise, innovative, and reliable teams with Newel to drive manufacturing leadership.
            </p>
            <a
              href="#contact"
