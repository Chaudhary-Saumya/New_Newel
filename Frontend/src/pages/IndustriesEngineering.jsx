  ...
  const challenges = [
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3a.75.75 0 01.75.75V6h3V3.75a.75.75 0 011.5 0V6h1.5a.75.75 0 010 1.5H15v3h3.75a.75.75 0 010 1.5H15v1.5a.75.75 0 01-1.5 0V12h-3v3.75a.75.75 0 01-1.5 0V12H6.75a.75.75 0 010-1.5H9v-3H5.25a.75.75 0 010-1.5H9V3.75A.75.75 0 019.75 3z"/>
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14v7m-7 0h14"/>
        </svg>
      ),
    },
  ];
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Engineering Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Mechanical Design" : index === 1 ? "Electrical Systems" : "Process Automation"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Advanced mechanical engineering" : index === 1 ? "Power & control systems" : "Industrial automation solutions"}
                    </p>
                  </div>
                </div>
              ))}
