// components/IndustriesSemiconductor.jsx
...
// Semiconductor related images (chip fabrication, cleanroom, wafer processing)
const heroImages = [
  ...
  const challenges = [
    {
      ...
      desc: "Sourcing electrical engineers and design verification experts to create and validate complex integrated circuits.",
      icon: (
    ...
    {
      title: "Cleanroom Operations & Precision",
      desc: "Staffing cleanroom technicians to maintain ultra-clean environments and handle delicate wafer processing.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Yield Analysis & Optimization",
      desc: "Recruiting yield analysts to identify defects, improve processes, and maximize production efficiency.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Fabrication Equipment Maintenance",
      desc: "Providing skilled technicians for lithography, etching, deposition, and other high-precision tools.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Supply Chain & Scaling Precision",
      desc: "Ensuring continuity of rare materials and scaling production while maintaining nanometer-level accuracy.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              From chip design to fabrication, we recruit electrical engineers, cleanroom technicians, design verification experts, and yield analysts.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              Who understand the fast-paced, precision-driven world of semiconductors.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Semiconductor Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Cleanroom Precision" : index === 1 ? "Wafer Fabrication" : "Advanced Chip Equipment"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Ultra-clean manufacturing environments" : index === 1 ? "Nanoscale wafer processing" : "High-tech lithography systems"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Semiconductor Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Power Your Semiconductor Growth?
            </h2>
