// components/IndustriesTelecommunication.jsx
  ...
  const challenges = [
    {
      ...
      desc: "Sourcing skilled network engineers to design, deploy, and optimize 5G, fiber, and wireless infrastructures.",
      icon: (
    ...
    {
      title: "Fiber Optics & Installation Expertise",
      desc: "Providing certified fiber optic technicians for high-speed splicing, testing, and maintenance of optical networks.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Project Management & Rollouts",
      desc: "Staffing experienced project managers to oversee large-scale network expansions, upgrades, and integration projects.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Customer Support & Service Excellence",
      desc: "Building responsive support teams to handle troubleshooting, service activations, and customer retention initiatives.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Innovation & Tech Adoption",
      desc: "Recruiting specialists in emerging tech like IoT, SDN, and AI-driven networks to fuel innovation and competitive edge.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              The telecom sector thrives on speed and connectivity—and so do we.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              From network engineers and fiber optic technicians to project managers and customer support, we deliver talent to support your expansion and innovation.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {heroImages.map((img, index) => (
                ...
                >
                  <img 
                    src={img} 
                    alt={`Telecommunication Solution ${index + 1}`}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Network Infrastructure" : index === 1 ? "Fiber Optic Connectivity" : "Data Center Operations"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "High-capacity telecom towers" : index === 1 ? "Advanced fiber networks" : "Scalable data centers"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Telecommunication Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Accelerate Your Telecom Growth?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Connect with top talent in engineering, tech, and support through Newel to drive seamless expansion and innovation.
            </p>
            <a
              href="#contact"
