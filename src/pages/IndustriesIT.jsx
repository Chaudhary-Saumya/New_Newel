...
export default function IndustriesIT() {
  ...
  const challenges = [
    {
      title: "Developer Talent Acquisition",
      desc: "Sourcing skilled software developers proficient in modern languages, frameworks, and agile methodologies.",
      icon: (
    ...
    {
      title: "Cybersecurity Analysis & Protection",
      desc: "Recruiting analysts expert in threat detection, vulnerability assessment, and secure system implementation.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Staffing architects to design scalable cloud solutions, manage migrations, and optimize AWS, Azure, or GCP environments.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Support Staff & Operations",
      desc: "Providing reliable IT support specialists for helpdesk, troubleshooting, and maintaining seamless operations.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Recruiting analysts to bridge tech and business needs, conduct requirements gathering, and drive project success.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              We help tech companies and IT service providers hire skilled developers, cybersecurity analysts, cloud architects, support staff, and business analysts.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              Whether contract or permanent, we scale your tech teams fast and effectively.
            </p>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Software Development" : index === 1 ? "Cybersecurity Solutions" : "Cloud Computing"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Innovative coding environments" : index === 1 ? "Advanced security operations" : "Scalable cloud architectures"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for IT Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Scale Your IT Teams?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Hire top developers, analysts, architects, and support staff with Newel for fast, effective growth.
            </p>
            <a
              href="#contact"
