...
const heroImages = [
  ...
  "https://images.unsplash.com/photo-1474314170901-f351b68f544f?w=800&h=600&fit=crop",
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Offshore Operations" : index === 1 ? "Refinery Excellence" : "Energy Analytics"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Safe offshore drilling operations" : index === 1 ? "Advanced refining technologies" : "Data-driven energy insights"}
                    </p>
                  </div>
                </div>
              ))}
