// components/IndustriesChemical.jsx
...
// Chemical industry related images (reactors, plants, labs)
const heroImages = [
  "https://www.ifa-technology.net/fileadmin/_processed_/5/3/csm_Chemiereaktor_Chemical_Reactor_1_f024414cf9.jpg",  // Industrial chemical reactors and piping
  "https://thumbs.dreamstime.com/b/large-scale-reactor-chemical-plant-long-row-steel-reservoirs-pipes-factory-industrial-interior-background-tanks-tubes-367379511.jpg",  // Large-scale chemical plant reactors
  "https://sensorex.com/wp-content/uploads/2021/10/pexels-magda-ehlers-2569839.jpg",  // Modern chemical processing facility interior
];

export default function IndustriesChemical() {
  ...
  const challenges = [
    {
      ...
      desc: "Attracting chemists, researchers, and scientists with deep expertise in formulation, synthesis, and innovation.",
      icon: (
    ...
    },
    {
      ...
      desc: "Staffing experienced process engineers to enhance efficiency, yield, and scalability in complex chemical production.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      desc: "Ensuring teams understand and implement rigorous safety protocols, hazard management, and regulatory standards.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Regulatory Expertise & Global Standards",
      desc: "Sourcing professionals versed in REACH, EPA, OSHA, and international compliance to maintain safe, legal operations.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
      title: "Innovation & Sustainability Drive",
      desc: "Building teams that advance green chemistry, waste reduction, and sustainable processes while meeting production goals.",
      icon: (
        <svg className="w-8 h-8 text-[#5099ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div ref={heroRef} className="text-center mb-20 lg:mb-32">
            ...
            <p className="mt-8 text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
              The chemical industry demands a specialized workforce familiar with R&D, process engineering, and environmental safety standards.
            </p>
            <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
              We help chemical manufacturers and labs source talent with the technical background and regulatory expertise to keep operations safe, innovative, and compliant with global standards.
            </p>
          ...
          <div ref={heroImgRef} className="mb-24 lg:mb-40">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 text-center mb-8">
              Our Chemical Industry Solutions
            </h2>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <p className="text-white font-bold text-lg">
                      {index === 0 ? "Reactor & Process Design" : index === 1 ? "Industrial Scale Production" : "Advanced Chemical Facilities"}
                    </p>
                    <p className="text-white/80 text-sm mt-1">
                      {index === 0 ? "Precision reactors and piping systems" : index === 1 ? "Large-scale manufacturing environments" : "Modern processing and control systems"}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className="mb-24 lg:mb-40">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-12 lg:mb-16">
              Challenges We Solve for Chemical Leaders
            </h2>
          ...
          <div ref={ctaRef} className="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 lg:p-12 shadow-lg border border-blue-100/50">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Ready to Strengthen Your Chemical Operations?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              Source safe, innovative, and compliant talent with Newel to power your chemical future.
            </p>
            <a
              href="#contact"
